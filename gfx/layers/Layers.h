...
class LayerTreeManager : public RefCounted<LayerTreeManager>
{
public:
  enum LayersBackend {
    LAYERS_NONE = 0,
   ...
   * Which image format to use as an alpha mask with this layer manager.
   */
  gfxASurface::gfxImageFormat MaskImageFormat() 
  { return gfxASurface::ImageFormatA8; }
 ...
 * surface.
 */
class LayerData : public RefCounted<LayerData> {
...
public:
  ...
  Layer* GetNextSibling() { return mNextSibling; }
  Layer* GetPrevSibling() { return mPrevSibling; }
  virtual Layer* GetFirstChild() { return NULL; }
...
public:
   ...
   * valid to set/get user data from it.
   */
  LayerTreeManager* Manager() { return mManager; }
...
protected:
  Layer(LayerTreeManager* aManager) :
    mManager(aManager)
    {}

  void Mutated(DataField aField)
  { mMutatedFields |= aField; }

  LayerTreeManager* mManager;
  uint32_t mMutatedFields;
};

class THEBES_API CanvasLayerData
{
public:
  CanvasLayerData() : mFilter(gfxPattern::FILTER_GOOD)
  { }
 ...
 * must not be modified during a layer transaction.
 */
class THEBES_API CanvasLayer
  : public Layer
  , public CanvasLayerData
{
public:
  struct Data {
    Data()
...
protected:
  CanvasLayer(LayerTreeManager* aManager, void* aImplData)
    : Layer(aManager),
...
class THEBES_API ThebesLayerData
{
public:
  ThebesLayerData()
  { }
...
class THEBES_API ColorLayerData
{
public:
  ColorLayerData()
    : mColor(0.0, 0.0, 0.0, 0.0)
  ...
  // This getter can be used anytime.
  const gfxRGBA& GetColor() { return mColor; }
protected:
  gfxRGBA mColor;
};
...
class THEBES_API ContainerLayerData
{
public:
  ContainerLayerData()
    : mFirstChild(nsnull)
  ...
  Layer* GetLastChild() { return mLastChild; }
 ...
 * children.
 */
class THEBES_API ContainerLayer
  : public Layer
