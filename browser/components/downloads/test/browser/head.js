...
//
// Here we define the "yy" variable used in iteration loops for sub-generators,
// in order to save some space for the "let" in all the iteration calls.
//
...
function gen_addDownloadRows(aDataRows)
{
  ...
  try {
    ...
    for (i = aDataRows.length - 1; i >= 0; i--) {
