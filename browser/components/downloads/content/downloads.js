...
const DownloadsPanel = {
  ...
  showPanel: function DP_showPanel()
  {
    ...
    // Delay displaying the panel because this function will sometimes be called
    // while another window is closing (like the window for selecting whether to
    // save or open the file), and that would cause the panel to close
    // immediately.
