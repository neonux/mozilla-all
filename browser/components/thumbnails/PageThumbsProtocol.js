...
let pageThumbsJSM = "resource:///modules/PageThumbs.jsm";
XPCOMUtils.defineLazyModuleGetter(this, "PageThumbsUtils", pageThumbsJSM);
XPCOMUtils.defineLazyModuleGetter(this, "PageThumbsChannel", pageThumbsJSM);
...
Protocol.prototype = {
  ...
  newChannel: function Proto_newChannel(aUri) {
    let {url} = PageThumbsUtils.parseUri(aUri);
    ...
    // to redirect to.
    return new PageThumbsChannel(aUri);
  },
