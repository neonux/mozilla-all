...
var gAdvancedPane = {
  ...
  updateReadPrefs: function ()
  {
    ...
    if (!enabledPref.value)   // Don't care for autoPref.value in this case.
      radiogroup.value="manual"     // 3. Don't check for updates automatically.
    else if (autoPref.value)  // enabledPref.value && autoPref.value
      radiogroup.value="auto";      // 1. Automatically install updates
    else                      // enabledPref.value && !autoPref.value
      radiogroup.value="checkOnly"; // 2. Check, but don't download and install
  ...
  updateWritePrefs: function ()
  {
    ...
    switch (radiogroup.value) {
      case "auto":      // 1. Automatically install updates
        ...
        autoPref.value = true;
        break;
      case "checkOnly": // 2. Check, but don't download and install
        enabledPref.value = true;
        autoPref.value = false;
        break;
      case "manual":    // 3. Don't check for updates automatically.
