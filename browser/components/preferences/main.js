...
var gMainPane = {
  ...
  {
    var showWhenDownloadingUI = document.getElementById("showWhenDownloading");
    var closeWhenDoneUI = document.getElementById("closeWhenDone");

    // These radio-buttons should not be visible if we have enabled the Downloads Panel.
    showWhenDownloadingUI.hidden = !DownloadsCommon.useWindowUI;
    closeWhenDoneUI.hidden = showWhenDownloadingUI.hidden;
  },
