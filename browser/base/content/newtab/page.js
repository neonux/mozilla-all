...
let gPage = {
  ...
  updateModifiedFlag: function Page_updateModifiedFlag() {
    ...
    this._updateTabIndeces(gAllPages.enabled, modified);
  },
  ...
  _updateAttributes: function Page_updateAttributes(aValue) {
    ...
    this._updateTabIndeces(aValue, this._isModified());
  },
   ...
   */
  _updateTabIndeces: function Page_updateTabIndeces(aEnabled, aModified) {
