...
var ConditionalForwardButton = {
  _conditionalForwardButtonShouldBeEnabled: function (navbar, forwardButton, urlbar) {
    ...
    return navigatorToolbox && navbar && unifiedBackForwardButton &&
  ...
  init: function init() {
    ...
    if (this._conditionalForwardButtonShouldBeEnabled(navbar, forwardButton, urlbar)) {
  ...
  observe: function (aSubject, aTopic, aState) {
    ...
    if (this._conditionalForwardButtonShouldBeEnabled(navbar, forwardButton, urlbar)) {
      if (aState == "disabled") {
        ...
        unifiedBackForwardButton.setAttribute("forwardDisabled", "true");
      } else {
        urlbar.removeAttribute("forwardDisabled");
        unifiedBackForwardButton.removeAttribute("forwardDisabled");
      }
    }
  }
};
