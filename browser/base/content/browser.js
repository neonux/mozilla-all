...
var ConditionalForwardButton = {
  init: function init() {
    ...
    if (urlbar && urlbarContainer.parentNode.getAttribute("mode") == "icons" &&
        urlbarContainer.parentNode.getAttribute("iconsize") == "large" &&
        unifiedBackForwardButton && unifiedBackForwardButton.nextSibling == urlbarContainer && forwardButton) {
  ...
  uninit: function uninit() {
    ...
    this.urlbar.removeAttribute("forwardDisabled");
    this.urlbar = null;
